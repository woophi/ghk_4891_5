...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '4891_confirm_var5');
    setLoading(true);
  ...
  const openCalc = () => {
    window.gtag('event', '4891_calc_var5');
    setOpenBs(true);
  };
    ...
    <>
      <div className={appSt.container}>
        ...
        <Steps isVerticalAlign interactive={false} className={appSt.stepStyle}>
          ...
          <span>
            ...
            <Typography.Text
              ...
              color="secondary"
              onClick={() => {
                window.gtag('event', '4891_income_var5');
                window.location.replace('alfabank://longread?endpoint=v1/adviser/longreads/48924');
              }}
              style={{
                color: '#2A77EF',
                cursor: 'pointer',
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ1_var5');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ2_var5');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ3_var5');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ4_var5');
        ...
        <div
          onClick={() => {
            window.gtag('event', '4891_moreinfo_var5');
